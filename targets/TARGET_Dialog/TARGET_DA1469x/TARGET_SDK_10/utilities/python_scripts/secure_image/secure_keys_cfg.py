...
def add_device_args(parser):
    supported_revisions = [ProductId.DA14683_00.value, ProductId.DA1469x_00.value]

    group = parser.add_argument_group('Product ID',
                                      "Combined with '-h/--help' flag will display product "
                                      "specific parameters.")

    group.add_argument('--prod_id', '-p', type=str, metavar="PROD_ID",
                       help='device product id {}'.format(supported_revisions),
    ...
    if args.prod_id == ProductId.DA14683_00:
        group = parser.add_argument_group(args.prod_id,
