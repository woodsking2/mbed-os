...
#define POWER_CTRL_REG_SET(_field, _val) CRG_TOP->POWER_CTRL_REG = (CRG_TOP->POWER_CTRL_REG & ~CRG_TOP_POWER_CTRL_REG_##_field##_Msk) | ((_val) << CRG_TOP_POWER_CTRL_REG_##_field##_Pos)

namespace
{

static struct da1469x_retreg g_mcu_dcdc_config[5];
static void da1469x_prail_configure_3v0(void)
{
    ...
    POWER_CTRL_REG_SET(V30_LEVEL, 2);    /* 3.300 V */
    POWER_CTRL_REG_SET(LDO_3V0_MODE, 3); //auto selection vbat or vbus
...
static void da1469x_prail_configure_1v8(void)
{
...
static void da1469x_prail_configure_1v8p(void)
{
...
static void da1469x_prail_configure_1v2(void)
{
...
static void da1469x_prail_configure_1v4(void)
{
